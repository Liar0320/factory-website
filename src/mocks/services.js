...
export default [
  ...
  /**获取公司历史展示信息 */
  // {
  //   url: `${baseDir}/company/history/list`,
  //   type: 'get',
  //   response: () => {
  //     const histroyList = [];
  ...
  //       workshop.imgs = new Array(Math.round(Math.random(0, 1) * 10)).fill(
  //         companynews,
  //       );
